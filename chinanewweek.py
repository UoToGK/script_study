...
class Weibospider:
    def __init__(self):
        ...
        self.headers = headers = {
            ...
            "cookie": "UM_distinctid=16ebb2a69e87c9-0f9e77de80db66-7373e61-1fa400-16ebb2a69e946c; SINAGLOBAL=9078084295180.92.1575098149469; wb_timefeed_6690784751=1; un=17603072726; UOR=www.baidu.com,vdisk.weibo.com,www.baidu.com; _s_tentry=-; Apache=5969289204660.753.1585529545925; ULV=1585529546113:6:6:3:5969289204660.753.1585529545925:1585529422871; YF-V5-G0=b588ba2d01e18f0a91ee89335e0afaeb; login_sid_t=a1b36aa8569334a7ada0807d41fca60b; cross_origin_proto=SSL; Ugrow-G0=d52660735d1ea4ed313e0beb68c05fc5; wb_view_log=1920*10801; SUBP=0033WrSXqPxfM725Ws9jqgMF55529P9D9WW.SXm1.8LQ2ZBeT8uJcM.m5JpX5K2hUgL.Foqc1K5N1hBNSK22dJLoIpRLxKqL1-eLBo2LxKqL1K.L1KeLxK-LB.BLB-e7eKzt; SSOLoginState=1585529613; ALF=1617065624; SCF=AudfR6nptB5k5GPk2ngKX-Z921MsZz1mk6ZCW1y-e2Dc0QXJl4kiMyT5zcjGXkDOG3YDe7_0RZuQkzLFnED4JR8.; SUB=_2A25zhTNKDeRhGeBI4lIW-CrLzj2IHXVQ8yOCrDV8PUNbmtAfLWfdkW9NRn5AI4TxPfbWJh9Y5C6eU3zkcItUuXrw; SUHB=0wn1fugEww6MPn; wb_view_log_6690784751=1920*10801; wvr=6; YF-Page-G0=5bc97a6cfd7c6118034eb50fd448c00e|1585539144|1585539031; webim_unReadCount=%7B%22time%22%3A1585539200919%2C%22dm_pub_total%22%3A0%2C%22chat_group_client%22%3A0%2C%22allcountNum%22%3A42%2C%22msgbox%22%3A0%7D",
    ...
    def run(self):
        ...
        for i in range(12):  # 微博共有12页
            ...
            for j in range(len(all_url)):
                # print(all_url[j])
                path_name = "chinanewweek第{}条微博相关评论.txt".format(i * 45 + j + 1)
