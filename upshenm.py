...
url = "https://www.smzdm.com/fenlei/baoxianchanpin/p{}"
headers = {
...
def get_all_links():
    for i in range(1, 21, 1):
        getLink = url.format(i)
        links_list.append(get_every_page_link(getLink))
    return links_list


def visit_every_link():
